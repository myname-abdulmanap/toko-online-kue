...
@section('title', 'Semua Produk - Kukerku')
...
<section class="page-header">
    <div class="container">
        <div class="page-header-content">
            ...
            <h1 class="display-4 font-display fw-bold text-dark mb-3">Semua Produk</h1>
            <p class="lead text-muted mb-0">Pilih kue kering premium favorit Anda</p>
        </div>
    </div>
</section>
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h5 class="mb-3 mb-md-0">
                        ...
                        <span class="text-muted">dari semua produk</span>
                    </h5>
                </div>
                <div class="col-md-6">
