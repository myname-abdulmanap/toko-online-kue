...
@section('title', 'Produk Satuan - Kukerku')
        ...
        <div class="page-header-content">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-custom">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Produk Satuan</li>
                </ol>
            </nav>
            <h1 class="display-4 font-display fw-bold text-dark mb-3">Produk Satuan</h1>
            <p class="lead text-muted mb-0">Pilih kue kering premium favorit Anda dalam kemasan satuan yang praktis</p>
        </div>
    </div>
</section>
    ...
    <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h5 class="mb-3 mb-md-0">
                        ...
                        <span class="text-muted">produk satuan</span>
                    </h5>
                </div>
                <div class="col-md-6">
        ...
        @else
            <div class="empty-state fade-in">
                ...
                <p class="mb-4">Produk satuan sedang dalam proses persiapan. Silakan cek kembali nanti atau lihat produk paket kami.</p>
                <a href="{{ url('/product') }}" class="btn-primary-custom">Lihat Produk Paket</a>
            </div>
        @endif
    </div>
</section>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <div class="d-flex flex-wrap justify-content-center gap-3">
                    <a href="https://wa.me/6289688037437" class="btn-primary-custom">
                        💬 Chat WhatsApp
                    </a>
